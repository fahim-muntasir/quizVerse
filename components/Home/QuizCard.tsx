...
import { Clock, Users, Share2, Trash2, Award, ToggleLeft, ToggleRight, ChevronRight } from 'lucide-react';
  ...
  const handleShare = (platform: 'copy' | 'twitter' | 'facebook') => {
    ...
    switch (platform) {
      case 'copy':
        ...
        break;
      case 'twitter':
        window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(quizUrl)}&text=Check out this quiz: ${title}`);
        break;
      case 'facebook':
        window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(quizUrl)}`);
        break;
    }
